...
namespace RakNet
{
    ...
    public:
        ...
        /// Sends a byte stream
        void Send(const char *data, size_t length, const SystemAddress &systemAddress, bool broadcast);

        // Sends a concatenated list of byte streams
        bool SendList(const char **data, const size_t *lengths, size_t numParameters, const SystemAddress &systemAddress, bool broadcast);
