...
/// \ingroup TEAM_MANAGER_GROUP
    ...
    public:
        ...
        size_t GetWorldIndex(void) const;
...
/// \ingroup TEAM_MANAGER_GROUP
    ...
    public:
        ...
        size_t GetTeamMembersCount(void) const;
        ...
        TM_TeamMember *GetTeamMemberByIndex(size_t index) const;
    ...
    protected:
        ...
        size_t GetMemberWithRequestedSingleTeamSwitch(TM_Team *team);
...
/// \ingroup TEAM_MANAGER_GROUP
    ...
    public:
        ...
        size_t GetTeamCount(void) const;
        ...
        size_t GetTeamIndex(const TM_Team *team) const;
        ...
        size_t GetTeamMemberCount(void) const;
        ...
        NetworkID GetTeamMemberIDByIndex(size_t index) const;
        ...
        size_t GetTeamMemberIndex(const TM_TeamMember *teamMember) const;
        ...
        /// \internal
        static int
        JoinRequestHelperComp(const TM_World::JoinRequestHelper &key, const TM_World::JoinRequestHelper &data);
    ...
    protected:
        ...
        size_t GetAvailableTeamIndexWithFewestMembers(TeamMemberLimit secondaryLimit, JoinPermissions joinPermissions);
        ...
        void BroadcastToParticipants(unsigned char *data, size_t length, RakNetGUID exclusionGuid);
...
/// \ingroup TEAM_MANAGER_GROUP
    ...
    public:
        ...
        size_t GetWorldCount(void) const;
    ...
    protected:
        ...
        void
        DecomposeTeamFullOrLocked(RakNet::BitStream *bsIn, TM_World **world, TM_TeamMember **teamMember, TM_Team **team,
                                  uint16_t &currentMembers, uint16_t &memberLimitIncludingBalancing,
                                  bool &balancingIsActive, JoinPermissions &joinPermissions);
