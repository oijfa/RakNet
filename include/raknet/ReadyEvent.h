...
/// \ingroup READY_EVENT_GROUP
    ...
    public:
        ...
        bool SetEvent(unsigned eventId, bool isReady);
        ...
        void ForceCompletion(unsigned eventId);
        ...
        bool IsEventCompletionProcessing(unsigned eventId) const;
        ...
        bool IsEventCompleted(unsigned eventId) const;
        ...
        size_t GetEventListSize(void) const;
        ...
        bool AddToWaitList(unsigned eventId, RakNetGUID guid);
        ...
        /// \return True on success, false on unknown eventId (this should be considered an error)
        bool RemoveFromWaitList(unsigned eventId, RakNetGUID guid);
        ...
        bool IsInWaitList(unsigned eventId, RakNetGUID guid);
        ...
        size_t GetRemoteWaitListSize(unsigned eventId) const;
        ...
        RakNetGUID GetFromWaitListAtIndex(unsigned eventId, unsigned index) const;
        ...
        ReadyEventSystemStatus GetReadyStatus(unsigned eventId, RakNetGUID guid);
        ...
        {
            unsigned eventId; // Sorted on this
            MessageID eventStatus;
            DataStructures::OrderedList<RakNetGUID, RemoteSystem, ReadyEvent::RemoteSystemCompByGuid> systemList;
        };
        static int ReadyEventNodeComp(const unsigned &key, ReadyEvent::ReadyEventNode *const &data);
    ...
    protected:
        ...
        */
        ...
        unsigned CreateNewEvent(unsigned eventId, bool isReady);
        bool SetEventByIndex(unsigned eventIndex, bool isReady);

        DataStructures::OrderedList<unsigned, ReadyEventNode *, ReadyEvent::ReadyEventNodeComp> readyEventNodeList;
