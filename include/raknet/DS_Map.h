...
#pragma warning( disable : 4127 ) // warning C4127: conditional expression is constant
        ...
        key_type GetKeyAtIndex(size_t position) const;
    ...
    size_t Map<key_type, data_type, key_comparison_func>::GetIndexAtKey( const key_type &key )
    {
        ...
        bool objectExists;
        size_t index = mapNodeList.GetIndexFromKey(key, &objectExists);
    ...
    template <class key_type, class data_type, int (*key_comparison_func)(const key_type&,const key_type&)>
    void Map<key_type, data_type, key_comparison_func>::RemoveAtIndex(size_t index)
    {
    ...
    template <class key_type, class data_type, int (*key_comparison_func)(const key_type&,const key_type&)>
    data_type& Map<key_type, data_type, key_comparison_func>::operator[]( size_t position ) const
    {
        return mapNodeList[position].mapNodeData;
    }

    template <class key_type, class data_type, int (*key_comparison_func)(const key_type&,const key_type&)>
        key_type Map<key_type, data_type, key_comparison_func>::GetKeyAtIndex( size_t position ) const
    {
    ...
    template <class key_type, class data_type, int (*key_comparison_func)(const key_type&,const key_type&)>
    void Map<key_type, data_type, key_comparison_func>::SaveLastSearch(const key_type &key, size_t index) const
    {
        (void) key;
        (void) index;
